...
const bookstoreDB = require('./config/DBConnection'); //remove this one and uncomment the line above
// Connects to MySQL database 
//vidjotDB.setUpDB(false); // To set up database with new tables set (true)
bookstoreDB.setUpDB(false); //remove this one and uncomment the line above
