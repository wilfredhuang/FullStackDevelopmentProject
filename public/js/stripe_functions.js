...
const stripe123 = Stripe('pk_test_Ef7sYvL8k3tWVTxjADPpT4T700HuZCROoX')
const elements = stripe123.elements()
...
const card123 = elements.create('card', { style: style })
...
const cust_name = document.getElementById('customer-name').value
